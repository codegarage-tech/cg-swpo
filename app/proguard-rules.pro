...
-keep class com.meembusoft.safewaypharmaonline.util.Logger {*;}
...
-keep class com.paulrybitskyi.persistentsearchview.** { *; }
-keep interface com.paulrybitskyi.persistentsearchview.** { *; }
-keep class com.arthurivanets.adapster.** { *; }
-keep interface com.arthurivanets.adapster.** { *; }
-keep class com.meembusoft.safewaypharmaonline.fcm {*;}
-keep class com.meembusoft.safewaypharmaonline.model.** {*;}
-keep class com.meembusoft.safewaypharmaonline.retrofit.** {*;}
...
-dontwarn javax.**
-dontwarn io.realm.**
-keep class com.arindam.alarmmanager.**{*;}
-keepclassmembers class com.arindam.alarmmanager.** { *; }