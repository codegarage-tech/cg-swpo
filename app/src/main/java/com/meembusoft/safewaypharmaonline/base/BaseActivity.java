...
import com.meembusoft.safewaypharmaonline.util.RuntimePermissionManager;
...
import static com.meembusoft.safewaypharmaonline.util.RuntimePermissionManager.REQUEST_CODE_APP_INFO;
import static com.meembusoft.safewaypharmaonline.util.RuntimePermissionManager.REQUEST_CODE_PERMISSION;
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ungrantedPermissions.size() > 0) {
                ...
                if (!RuntimePermissionManager.getInstance().isPermissionRequested(ungrantedPermissions)) {
                    ...
                    //AppUser already requested runtime permission before
