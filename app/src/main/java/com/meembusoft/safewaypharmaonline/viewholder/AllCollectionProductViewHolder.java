 ...
 */
public class AllCollectionProductViewHolder extends BaseViewHolder<CommonData> {

    private static String TAG = AllCollectionProductViewHolder.class.getSimpleName();
    private TextView tvName,tvGenericName,tvAmount;
    private ImageView ivCollection;

    public AllCollectionProductViewHolder(ViewGroup parent) {
        super(parent, R.layout.row_see_collecttion_view);
