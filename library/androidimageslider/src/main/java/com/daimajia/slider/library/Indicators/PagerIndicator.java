...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener{
    ...
    public PagerIndicator(Context context, AttributeSet attrs) {
        ...
        int shape = attributes.getInt(R.styleable.PagerIndicator_indicator_shape, Shape.Oval.ordinal());
    ...
    public void setIndicatorVisibility(IndicatorVisibility visibility){
        ...
        }else if(visibility == IndicatorVisibility.Invisible){
            setVisibility(View.INVISIBLE);
        }else if(visibility == IndicatorVisibility.Gone){
