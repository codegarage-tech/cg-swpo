...
public class SliderLayout extends RelativeLayout{
    ...
    public enum Transformer{
        ...
        public static Transformer getRandomTransform() {
            Random random = new Random();
            int x = random.nextInt(Transformer.class.getEnumConstants().length);
            return Transformer.class.getEnumConstants()[x];
        }
    };
    ...
    public PagerIndicator.IndicatorVisibility getIndicatorVisibility(){
        ...
        return PagerIndicator.IndicatorVisibility.Gone;
