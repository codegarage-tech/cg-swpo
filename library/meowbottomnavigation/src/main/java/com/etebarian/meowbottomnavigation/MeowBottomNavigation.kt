...
class MeowBottomNavigation : FrameLayout {
    ...
    private var paintColor = Color.parseColor("#7EBF2F")
    ...
    private fun initializeViews() {
        ...
        ll_cells.apply {
            ...
            clipChildren = false
            clipToPadding = false
//            setBackgroundResource(R.drawable.meow_navigation_background)
        }
...
//            setBackgroundColor(Color.TRANSPARENT);
    ...
    fun setBezierColor(backgroundColor: Int){
        bezierView.apply {
            layoutParams = LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, heightCell)
            shadowColor = this@MeowBottomNavigation.shadowColor
            color = backgroundColor
        }
        bezierView.initializeViews()
    }
